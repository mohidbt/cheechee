...
export function Console({ state, tracks, engine, connected, services, busy, activities, analyses, analyzing, onAnalyze, autopilot, onAutopilotToggle, onObjectiveChange, onChangeInterval, onManualIntent, onCommand, onSubmit, onStopAll, onImport, voiceControls, speechToggle }: ConsoleProps) {
